...
@Deprecated
@FacesRenderer(componentFamily = "javax.faces.Command", rendererType = "com.junhong.forum.customcomponent.Pager")
public class PagerRenderer extends Renderer {
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException {
		...
		// int loadpages = toInt(component.getAttributes().get("loadpages"));
		// int totalrowscount =
		// toInt(component.getAttributes().get("totalrowscount"));
	...
	private void writeLink(ResponseWriter writer, UIComponent component, String formId, String id, String value,
	...
	private String onclickCode(String formId, String id, String value) {
		return new StringBuilder().append("document.forms['").append(formId).append("']['").append(id)
				.append("'].value='").append(value).append("'; document.forms['").append(formId)
