...
public class Messages {
	...
	public static FacesMessage getMessage(String bundleName, String resourceId, Object[] params, boolean requireDetailMess) {
		FacesContext context = FacesContext.getCurrentInstance();
		Application app = context.getApplication();
		String appBundle = app.getMessageBundle();
		Locale locale = getLocale(context);
		...
		if (summary == null)
			summary = "???" + resourceId + "???";
		String detail = "";
		if (requireDetailMess) {
			detail = getString(appBundle, bundleName, resourceId + "_detail", locale, loader, params);
		}
		return new FacesMessage(summary, detail);
	}
	 ...
	 * 
	 * @param bundle1
	 *            --will first get resource from bundle1, if not there, then
	 *            will get it from bundle2
	 * @param bundle2
	 * @param resourceId
	 * @param params
	 * @return
	 */
	public static String getString(String bundle1, String bundle2, String resourceId, Object[] params) {
		Locale locale = Locale.getDefault();
		ClassLoader loader = getClassLoader();
		return getString(bundle1, bundle2, resourceId, locale, loader, params);
	}
